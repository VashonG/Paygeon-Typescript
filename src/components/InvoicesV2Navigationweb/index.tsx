...
type InvoicesV2NavigationwebProps = Omit<
  React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>,
  "title" | "search"
> &
  Partial<{ title: string; search: string }>;

const InvoicesV2Navigationweb: React.FC<InvoicesV2NavigationwebProps> = (
  props,
) => {
  ...
  return (
    <>
      <div className={props.className}>
        <Text
          className="md:ml-[0] ml-[60px] text-black-900 text-lg"
        ...
        {!!props?.search ? (
          <Input
            ...
            wrapClassName="border border-blue_gray-100_b2 border-solid flex mb-1 md:ml-[0] ml-[536px] pl-[13px] pr-[35px] py-[9px] rounded-lg w-[27%] md:w-full"
            prefix={
...
InvoicesV2Navigationweb.defaultProps = { title: "Invoices" };

export default InvoicesV2Navigationweb;
