...
type Sidebar7Props = React.DetailedHTMLProps<
...
const Sidebar7: React.FC<Sidebar7Props> = (props) => {
  ...
  return (
    <>
      ...
      >
        <Img
          className="h-11 mb-[905px] ml-8 mr-[190px] mt-5 w-11"
        ...
        <Menu
          ...
          className="flex flex-col items-center justify-start mb-2 mt-[109px] w-full"
        >
          ...
          <div className="flex flex-col items-center justify-start mt-[182px] w-full">
            <MenuItem
              icon={
                <Img
                  className="h-[22px] w-[22px]"
                  src="images/img_settings_black_900_18x18.svg"
                  alt="settings"
                />
              }
              active={window.location.pathname === "/profilesettingsaccount"}
            >
              <Text className="mt-1 w-auto">Profile Settings</Text>
            </MenuItem>
          </div>
        </Menu>
      </Sidebar>
