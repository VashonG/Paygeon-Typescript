          ...
          <div className="flex flex-col gap-[45px] items-center justify-start ml-[undefinedpx] mr-20 my-auto w-[72%] z-[1]">
            ...
            <div className="flex md:flex-col flex-row gap-6 items-center justify-between w-full">
              <div className="flex md:flex-1 flex-col gap-6 items-center justify-start w-[49%] md:w-full">
                <List
                  className="sm:flex-col flex-row gap-6 grid sm:grid-cols-1 grid-cols-2 justify-center w-full"
                  orientation="horizontal"
                >
                  <InvoicesV2Column
                    className="border border-blue_gray-100_b2 border-solid flex flex-1 flex-col items-center justify-start sm:ml-[0] p-[17px] rounded-[12px] w-full"
                    title="Income"
                    price="$9.650,00"
                    subtitle="84 Transactions"
                  />
                  <InvoicesV2Column
                    className="border border-blue_gray-100_b2 border-solid flex flex-1 flex-col items-center justify-start sm:ml-[0] p-[18px] rounded-[12px] w-full"
                    title="Spendings"
                    price="$7.845,00"
                    subtitle="58 Transactions"
                    increasepercentage="-2%"
                  />
                </List>
                <div className="flex flex-col items-center justify-start w-full">
                  <DashboardV1Elementwidget className="border border-blue_gray-100_b2 border-solid flex flex-col gap-[7px] items-center justify-start pb-[13px] rounded-[12px] w-full" />
                </div>
              </div>
