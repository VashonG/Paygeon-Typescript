...
const InvoicesEmptyPage: React.FC = () => {
  ...
  return (
    <>
      <div className="bg-white-A700 flex font-inter h-[960px] justify-end mx-auto overflow-auto relative w-full">
        <Footer className="absolute bottom-[0] flex items-center justify-center md:px-5 right-[0] w-full" />
        <AccountsEmptyButtonsicon
          className="flex flex-col h-full items-center justify-start mb-[230px] ml-auto mr-[480px] mt-auto p-2.5 md:px-5 w-[16%]"
          lable="Create new invoice"
        />
        <div className="absolute flex inset-[0] justify-center m-auto md:px-5 w-full">
          <Sidebar5 className="!sticky !w-[266px] bg-blue_gray-50_99 flex h-screen md:hidden justify-start my-auto overflow-auto top-[0]" />
          <InvoicesV2Navigationweb className="bg-white-A700 flex md:flex-col flex-row md:gap-5 items-center justify-start ml-[-10px] p-5 w-[83%] z-[1]" />
          <div className="flex flex-col gap-[57px] items-center justify-start ml-[undefinedpx] mr-[390px] mt-60 w-[28%] z-[1]">
            <Img
              className="h-[250px]"
              src="images/img_undrawtermsheetreju7s.svg"
              alt="undrawtermsheet"
            />
